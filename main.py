...
manager = pygame_gui.UIManager((1920, 900))
...
center = (910, 450)
all_ships = [Ship(10, 50, 'textures/ships/test_ship.png', (0, 0), manager, mid_modules= [modules.module('piska'), modules.module('piska'), modules.module('piska'), modules.module('piska')], high_modules=[modules.module('piska'), modules.module('piska'), modules.module('piska'), modules.module('piska')]),
             Ship(70, 2, 'textures/ships/test_ship_big.png', (random.uniform(-500, 500), random.uniform(-500, 500)), manager)]
for i in range(9):
    all_ships.append(Ship(10, 10, 'textures/ships/test_ship.png', (random.uniform(-500, 500), random.uniform(-500, 500)), manager))
scale = 0.6
cam_x, cam_y = 0, 0
scroll_sense = 0.05
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_r:
                ...
                if len(selected_ships) != 0:
                    x, y = pygame.mouse.get_pos()[0] - cam_x, pygame.mouse.get_pos()[1] - cam_y
                    for i in all_ships:
                        if trigonometry.distance_between_points((i.x, i.y), (x * (1 / scale), y * (1 / scale))) <= i.diagonal / 2:
                            for j in selected_ships:
